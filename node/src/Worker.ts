...
export type WorkerUpdateableSettings<T extends AppData = AppData> =
	Pick<WorkerSettings<T>, 'logLevel' | 'logTags'>;
	...
	async updateSettings(
		{
			logLevel,
			logTags
		}: WorkerUpdateableSettings<WorkerAppData> = {}
	): Promise<void>
	{
	...
	async createWebRtcServer<WebRtcServerAppData extends AppData = AppData>(
		{
			listenInfos,
			appData
		}: WebRtcServerOptions<WebRtcServerAppData>
